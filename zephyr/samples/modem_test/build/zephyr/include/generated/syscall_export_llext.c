...
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_set_time;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_get_time;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_alarm_get_supported_fields;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_alarm_set_time;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_alarm_get_time;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_alarm_is_pending;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_alarm_set_callback;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_update_set_callback;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_set_calibration;
extern __weak ALIAS_OF(no_handler) void * const z_impl_rtc_get_calibration;
