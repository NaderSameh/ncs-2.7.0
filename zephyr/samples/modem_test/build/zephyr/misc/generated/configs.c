...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_PARSE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_NMEA0183, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_NMEA0183_MATCH, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_U_BLOX_M10_SATELLITES_COUNT, 24);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_LUATOS_AIR530Z_SATELLITES_COUNT, 24);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_MOCK_MODE, 1);
