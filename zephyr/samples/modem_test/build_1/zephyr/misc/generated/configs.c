...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_CELLULAR_CMUX_MAX_FRAME_SIZE, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_CELLULAR_CHAT_BUFFER_SIZES, 830);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_PPP_TIMEOUT, 3000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_L2_PPP_LOG_LEVEL, 0);
