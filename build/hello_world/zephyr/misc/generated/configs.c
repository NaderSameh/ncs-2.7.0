...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_GNSS_NMEA_GENERIC_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_NMEA_GENERIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_NMEA_GENERIC_SATELLITES_COUNT, 24);
